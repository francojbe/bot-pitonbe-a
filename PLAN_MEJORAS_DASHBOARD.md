...
- [ ] **Feedback de Carga:** Implementar Skeletons o Spinners mientras cargan los datos.
- [ ] **Buscador Global:** Mejorar la funcionalidad de búsqueda para filtrar órdenes y clientes en tiempo real.
- [ ] **Filtros Avanzados:** Agregar filtros por rango de fechas y estado.

## 3. Seguridad y Datos
- [ ] **Autenticación:** Implementar Login con Supabase Auth si se expone a internet.
- [ ] **Validación de Formularios:** Añadir validación robusta para RUT y Teléfono.
- [ ] **Constantes para Estados:** Definir objeto `ORDER_STATUS` para evitar errores de tipo.

## 4. Funcionalidades Potenciales
- [ ] **Historial de Cambios (Audit Log):** Mostrar cronología de cambios de estado y pagos en el `OrderDrawer`.
- [ ] **Vista Móvil:** Adaptar el Kanban o forzar vista de lista en dispositivos móviles.
