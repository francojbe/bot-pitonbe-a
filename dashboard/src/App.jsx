  ...
  return (
    <div className="relative w-full font-sans" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-full flex items-center justify-between bg-white dark:bg-[#111C44] border border-[#E0E5F2] dark:border-white/10 rounded-2xl px-4 py-3 shadow-none hover:shadow-[0px_18px_40px_rgba(112,144,176,0.12)] transition-all duration-200 outline-none"
      >
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 left-0 w-full bg-white dark:bg-[#111C44] border border-[#E0E5F2] dark:border-white/10 rounded-2xl shadow-[0px_20px_50px_rgba(112,144,176,0.12)] z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 p-2">
          {options.map((option) => (
            <button
              key={option}
              type="button"
              ...
              className={`w-full text-left flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold transition-all ${value === option ? 'bg-[#F4F7FE] dark:bg-white/10 text-[#2B3674] dark:text-white' : 'text-[#A3AED0] hover:bg-[#F4F7FE] dark:hover:bg-white/5 hover:text-[#2B3674] dark:hover:text-white'}`}
            >
